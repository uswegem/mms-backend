...
const PERMISSIONS = [
  ...
  { code: 'school:fee:read', module: 'school', description: 'View fee structures and academic config' },
  { code: 'school:fee:write', module: 'school', description: 'Manage fee structures and academic config' },
  { code: 'school:invoice:read', module: 'school', description: 'View school fee invoices' },
  { code: 'school:invoice:write', module: 'school', description: 'Generate and manage invoices' },
  { code: 'school:invoice:waive', module: 'school', description: 'Apply discounts, waivers, scholarships' },
  { code: 'school:invoice:cancel', module: 'school', description: 'Cancel invoices' },
  { code: 'school:payment:read', module: 'school', description: 'View fee payments and payer lookup' },
  { code: 'school:payment:mock', module: 'school', description: 'Simulate mock gateway payments (dev/demo)' },
  { code: 'school:payment:reverse', module: 'school', description: 'Reverse completed fee payments' },
  { code: 'school:recon:read', module: 'school', description: 'View reconciliation runs and summaries' },
  { code: 'school:recon:run', module: 'school', description: 'Start reconciliation runs' },
  { code: 'school:recon:ingest', module: 'school', description: 'Ingest settlement files / sim feeds' },
  { code: 'school:recon:exception:read', module: 'school', description: 'View reconciliation exception queue' },
  { code: 'school:recon:exception:resolve', module: 'school', description: 'Propose/resolve reconciliation exceptions' },
...
const ROLES: Array<{
  ...
  },
  {
    ...
    permissions: [
      ...
      'school:recon:run',
      'school:recon:ingest',
      'school:recon:exception:read',
      'school:recon:exception:resolve',
      'alias:read',
      'alias:lookup',
      'qr:read',
      'qr:generate',
  ...
  },
  {
    ...
    permissions: [
      ...
      'school:fee:write',
      'school:invoice:read',
      'school:invoice:write',
      'school:invoice:waive',
      'school:invoice:cancel',
      'school:payment:read',
      'school:payment:mock',
      'school:payment:reverse',
      'school:recon:read',
      'school:recon:exception:read',
      'alias:read',
      'qr:read',
...
async function main() {
  ...
  console.log('  Tip:      npx ts-node --transpile-only prisma/seed-school-fees.ts  # M4(a) demo fees');
}
