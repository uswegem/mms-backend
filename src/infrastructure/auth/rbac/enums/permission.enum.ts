...
export enum Permission {
  ...
  SCHOOL_FEE_READ = 'school:fee:read',
  SCHOOL_FEE_WRITE = 'school:fee:write',
  SCHOOL_INVOICE_READ = 'school:invoice:read',
  SCHOOL_INVOICE_WRITE = 'school:invoice:write',
  SCHOOL_INVOICE_WAIVE = 'school:invoice:waive',
  SCHOOL_INVOICE_CANCEL = 'school:invoice:cancel',
  SCHOOL_PAYMENT_READ = 'school:payment:read',
  SCHOOL_PAYMENT_MOCK = 'school:payment:mock',
  /** Seed these permissions for finance operations roles. */
  SCHOOL_PAYMENT_REVERSE = 'school:payment:reverse',
  SCHOOL_RECON_READ = 'school:recon:read',
  SCHOOL_RECON_RUN = 'school:recon:run',
  SCHOOL_RECON_INGEST = 'school:recon:ingest',
  SCHOOL_RECON_EXCEPTION_READ = 'school:recon:exception:read',
  SCHOOL_RECON_EXCEPTION_RESOLVE = 'school:recon:exception:resolve',
  // Alias
